...
import static gov.usgs.cida.nude.ResultSetUtils.createNudeRows;
...
public class ResultSetUtilsTest {
	...
	protected static ColumnGroup kitchenSinkColGroup = null;
	protected static Iterable<NudeRow> kitchenSinkDataset = null;
	protected static Iterable<NudeRow> identicalSinkDataset = null;
	protected static Iterable<NudeRow> thinSinkDataset = null;
	protected static Iterable<NudeRow> thinkSinkDataset = null;
	protected static Iterable<NudeRow> differentSinkDataset = null;
	protected static Iterable<NudeRow> filteredSinkDataset = null;
	
	@BeforeClass
	public static void setUpClass() throws Exception {
		log.info("Don't worry about logs here.");
		kitchenSinkColGroup = new ColumnGroupImpl(Arrays.asList(new Column[] {
		...
		kitchenSinkDataset = createNudeRows(
				kitchenSinkColGroup,
				new String[][] {
		...
		identicalSinkDataset = createNudeRows(
				kitchenSinkColGroup,
				new String[][] {
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:00:00").getMillis(), null, "7.97", "73.4", "103", null, null, null, ".13", null, null, null},
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:14:00").getMillis(), "9410", null, null, null, null, null, null, null, null, null, null},
		...
		ColumnGroup thinColGroup = new ColumnGroupImpl(Arrays.asList(new Column[] {
			new SimpleColumn("time"), 
			new SimpleColumn("00060"), 
			new SimpleColumn("00010"), 
			new SimpleColumn("63680"), 
		...
		thinSinkDataset = createNudeRows(
				thinColGroup,
				new String[][] {
		...
		ColumnGroup thinkColGroup = new ColumnGroupImpl(Arrays.asList(new Column[] {
			new SimpleColumn("time"), 
			new SimpleColumn("00060"), 
			new SimpleColumn("00010"), 
			new SimpleColumn("63680"), 
		...
		thinkSinkDataset = createNudeRows(
				thinkColGroup,
				new String[][] {
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:00:00").getMillis(), null, "7.97", "73.4", "103", null, null, null, ".13", null, null, null},
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:14:00").getMillis(), "9410", null, null, null, null, null, null, null, null, null, null},
		...
		differentSinkDataset = createNudeRows(
				kitchenSinkColGroup,
				new String[][] {
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:00:00").getMillis(), null, "7.97", "73.4", "103", null, null, null, ".13", null, null, null},
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:14:00").getMillis(), "9410", null, null, null, null, null, null, null, null, null, null},
		...
		filteredSinkDataset = createNudeRows(
				kitchenSinkColGroup,
				new String[][] {
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:00:00").getMillis(), null, "7.97", "73.4", "103", null, null, null, ".13", null, null, null},
					new String[] {"" + ISODateTimeFormat.localDateOptionalTimeParser().parseDateTime("2008-03-01T00:14:00").getMillis(), "9410", null, null, null, null, null, null, null, null, null, null},
